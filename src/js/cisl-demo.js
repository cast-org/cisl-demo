...
(function (fluid) {
        ...
        auxiliarySchema: {
            ...
            "textSize": {
                ...
                "panel": {
                    ...
                    template: "html/PrefsEditorTemplate-textSize.html",
                    message: "messages/textSize.json"
                },
                "enactor": {
            ...
            "textFont": {
                ...
                "panel": {
                    ...
                    message: "messages/textFont.json"
                }
            }
        }
    });
    ...
    fluid.defaults("cisl.prefs.auxSchema.glossary.demo", {
        ...
        auxiliarySchema: {
            glossary: {
                panel: {
                    template: "html/PrefsEditorTemplate-glossaryToggle.html",
                    message: "messages/glossary.json"
                },
                enactor: {
